...
[![x-cmd/install — qdrant Code Quality Monitoring Repo Card](https://repo.x-cmd.io/qdrant.svg?lang=zh)](https://x-cmd.com/install/qdrant)
...
- **Star**: 34,741 · **Fork**: 2,689 · **开放 issue**: 2,032 · **贡献者**: 205

## 累计统计

- **发布数**: 117 · **已合并 PR**: 6866 · **开放 PR**: 251 · **已关闭 issue**: 1531 · **开放 issue**: 501 · **提交数**: 6899
...
_数据快照: `data/card/260922.yml` · 2026-09-22T04:51:12Z._
